...
const drumSounds = {
    ...
    's': new Tone.Player("../sonidos/drumkit/s.wav").toDestination(),
    'd': new Tone.Player("../sonidos/drumkit/d.wav").toDestination(),
    'h': new Tone.Player("../sonidos/drumkit/h.wav").toDestination(),
